...
int main(int argc, char **argv)
{
    ...
    std::string pattern = "/media/pxw/PS2000/data/20240711data/front_jpg_2";
    ...
    for (auto it : file_names)
    {
        ...
        // std::string crop_image_path = "/home/pxw/project/traffic_light/data/";
        // auto split_str = Stringsplit(it, '/');
        // crop_image_path = crop_image_path + split_str[split_str.size() - 1];
